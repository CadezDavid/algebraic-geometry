...
\begin{exercise}{3}
    \begin{enumerate}
        \item{Let $\mathcal{F}, \mathcal{G}$ be presheaves on $X$ and
            ...
            limits and colimits of the abused groups, but these are a
            ...
            commutes with all colimits, because it is left-ajoint functor.\\
        ...
        \item{Assume $f \colon \mathcal{F} \rightarrow \mathcal{G}$ is
            ...
            \end{align*}
            are not the same since $\mathcal{H}$ is not trivial. However, by
