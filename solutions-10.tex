...
\begin{exercise}{4}
    ...
    \begin{enumerate}
        \item{
                Steps:
                \begin{itemize}
                    \item{We use equalizers to show that the scheme $\im(f)$
                        exists.}
                    \item{Using composition $X \to Z \to S$ we get that ideal
                        sheaf of $\im(f)$ is indeed contained in the kernel of
                        $f^\# \colon \mathcal{O}_S \to f_*(\mathcal{O}_X)$.}
                    \item{Show that ideal sheaf of a closed immersion is
                        indeed a quasi-coherent sheaf.}
                    \item{Show that every quasi-coherent ideal sheaf $I
                        \subseteq \ker(f^\#)$ induces a closed immersion $Z_I
                        \hookrightarrow S$.}
                    \item{Show that if $I \subseteq J \subseteq \ker(f^\#)$,
                        then $Z_I \hookrightarrow Z_J \hookrightarrow S$, where
                        $Z_I$ and $Z_J$ are closed immersion that they induce.}
                \end{itemize}
            }
        \item{
                Steps:
