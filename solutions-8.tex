...
\begin{exercise}{3}
    \begin{enumerate}
        ...
        \item{
                At first it was not completely clear to us what the map $f^* \colon \Gamma(\Proj^m_k,
                \mathcal{O}_{\Proj^m_k}(1)) \to \Gamma(\Proj^n_k,
                \mathcal{O}_{\Proj^n_k} (d))$ is. So we assumed it is the following:
                For a global section $f \in \Gamma(\Proj^m_k,
                ...
                \end{equation*}
                So include $f'$ into $\Gamma(\Proj^n_k, f^*
                \mathcal{O}_{\Proj^m_k}(1))$ as $f' \otimes 1$.

                The polynomials $y_0, \dots, y_n$ generate the module of
